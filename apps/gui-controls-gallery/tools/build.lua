...
for _, required in ipairs({
    ...
    lua .. "/src/lua.h",
    root .. "/third_party/yyjson-0.12.0/src/yyjson.c",
    root .. "/third_party/yyjson-0.12.0/src/yyjson.h",
    wrapper_jar,
    prefix .. "/bin/clang",
    prefix .. "/bin/clang++",
...
local download = "/sdcard/Download/squared_gui_controls_gallery-debug.apk"
local download_test = io.open(
    "/sdcard/Download/.squared-pg-write-test",
    "wb"
)
if download_test then
    download_test:close()
    os.remove("/sdcard/Download/.squared-pg-write-test")
